...
try {
    // Create tables
    $conn->query("CREATE TABLE IF NOT EXISTS service_categories (
    ...
    $categories = [
        ['Insta Help', '⚡', '#FFE5E5', 'Quick emergency fixes'],
        ['Women\'s Salon & Spa', '💇‍♀️', '#FFF0E5', 'Beauty & wellness'],
        ['Men\'s Salon & Massage', '💆‍♂️', '#F0F5FF', 'Grooming & relaxation'],
        ['Professional Cleaning', '🧹', '#E5F5E5', 'Deep & regular cleaning'],
        ['Home Paint', '🎨', '#FFF5E5', 'Painting & waterproofing'],
        ['AC & Appliances', '❄️', '#E5F5FF', 'AC & appliance repair'],
        ['Electrician', '🔧', '#FFF5E5', 'Electrical work'],
        ['Vehicle Care', '🚗', '#FFE5F5', 'Car & bike services'],
        ['Food & Catering', '🍳', '#F5E5FF', 'Cooking & catering'],
        ['Health & Care', '🏥', '#E5FFE5', 'Medical & wellness'],
        ['Pooja Services', '🙏', '#FFFFE5', 'Religious ceremonies'],
        ['Festival Services', '🎉', '#FFE5E5', 'Event decoration'],
        ['Pest Control', '🐜', '#FFF5E5', 'Pest management'],
        ['Smart Society Hub', '🏢', '#E5F5FF', 'Society management'],
        ['Water Testing', '🧪', '#E0F2FE', 'Water quality check'],
        ['Blood Testing', '🩸', '#FFE0E0', 'Lab testing'],
        ['Weekly Bazar', '🛒', '#E8F5E9', 'Grocery delivery'],
        ['Real Estate', '🏠', '#FFE5F5', 'Property services'],
        ['Hologram Services', '🔮', '#E5FFE5', 'Holographic displays'],
        ['Tours & Travels', '✈️', '#E5FFE5', 'Travel services'],
    ];
    ...
    // ALL SERVICES FROM PRICING SPREADSHEET
    $allServices = [
        // INSTA HELP (9 services)
        ...
        // WOMEN'S SALON & SPA (19 services)
        ['Women\'s Salon & Spa', 'Hair Cut & Styling (Women)', '✂️', 599, '45-60 min', 4.9],
        ...
        ['Women\'s Salon & Spa', 'Head Massage & Spa', '🧖‍♀️', 699, '60 min', 4.9],
        ...
        // MEN'S SALON & MASSAGE (11 services)
        ['Men\'s Salon & Massage', 'Hair Cut (Men)', '✂️', 249, '30 min', 4.8],
        ['Men\'s Salon & Massage', 'Hair Cut (Kids Under 12)', '👧', 199, '20 min', 4.8],
        ['Men\'s Salon & Massage', 'Shave & Beard Styling', '🧔', 199, '20-30 min', 4.8],
        ['Men\'s Salon & Massage', 'Swedish Massage (60 min)', '💆‍♂️', 1299, '60 min', 4.9],
        ...
        // PROFESSIONAL CLEANING (15 services)
        ['Professional Cleaning', 'Home Deep Clean (1BHK)', '🏠', 3499, '3-4 hrs', 4.9],
        ['Professional Cleaning', 'Home Deep Clean (2BHK)', '🏠', 3999, '4-5 hrs', 4.9],
        ['Professional Cleaning', 'Home Deep Clean (3BHK)', '🏠', 4499, '5-6 hrs', 4.9],
        ['Professional Cleaning', 'Bathroom Deep Clean', '🚿', 599, '1.5-2 hrs', 4.9],
        ['Professional Cleaning', 'Kitchen Deep Clean', '🍳', 999, '2 hrs', 4.8],
        ['Professional Cleaning', 'Sofa Cleaning (3-Seater)', '🛋️', 899, '2 hrs', 4.8],
        ['Professional Cleaning', 'Carpet / Rug Dry Cleaning', '', 699, '2-3 hrs', 4.8],
        ['Professional Cleaning', 'Water Tank Cleaning (500L)', '', 999, '2 hrs', 4.9],
        ['Professional Cleaning', 'Mattress Cleaning & Sanitise', '', 699, '1-2 hrs', 4.8],
        ['Professional Cleaning', 'Office / Commercial Cleaning', '', 3999, '3-5 hrs', 4.7],
        ['Professional Cleaning', 'Post-Construction Cleaning', '', 5499, 'Full Day', 4.7],
        ['Professional Cleaning', 'Balcony & Window Cleaning', '', 449, '1 hr', 4.8],
        ['Professional Cleaning', 'Refrigerator Deep Clean', '', 399, '1 hr', 4.7],
        ['Professional Cleaning', 'Overhead / Sump Tank Cleaning', '', 1999, '3-4 hrs', 4.9],

        // HOME PAINT (11 services)
        ['Home Paint', 'Wall Painting (Per sq.ft)', '🎨', 18, 'Per sq.ft', 4.6],
        ['Home Paint', 'Full Home Painting (1BHK)', '', 12999, '2-3 days', 4.8],
        ['Home Paint', 'Full Home Painting (2BHK)', '', 18999, '3-4 days', 4.8],
        ['Home Paint', 'Full Home Painting (3BHK)', '', 26999, '4-5 days', 4.8],
        ['Home Paint', 'Waterproofing (Bathroom)', '', 3499, '1 day', 4.8],
        ['Home Paint', 'Waterproofing (Terrace / Roof)', '', 6999, '1-2 days', 4.9],
        ['Home Paint', 'Texture / Designer Painting', '', 75, 'Per sq.ft', 4.7],
        ['Home Paint', 'Wood Polish & Varnish', '', 2999, '1-2 days', 4.7],
        ['Home Paint', 'Gate & Grill Painting', '', 1999, '1 day', 4.7],
        ['Home Paint', 'Ceiling Painting Only', '', 4999, '1-2 days', 4.7],
        ['Home Paint', 'Enamel / Oil Paint (Wood & Metal)', '', 2999, '1 day', 4.7],

        // AC & APPLIANCES (15 services)
        ['AC & Appliances', 'AC Jet Service', '❄️', 599, '1.5-2 hrs', 4.8],
        ['AC & Appliances', 'AC Gas Refill (R32 / R410)', '', 2499, '1-1.5 hrs', 4.7],
        ['AC & Appliances', 'AC Installation (Split)', '', 1499, '3-4 hrs', 4.9],
        ['AC & Appliances', 'AC Installation (Window)', '', 799, '3-4 hrs', 4.9],
        ['AC & Appliances', 'AC Uninstallation', '', 499, '1-2 hrs', 4.8],
        ['AC & Appliances', 'Washing Machine Repair', '', 499, '1 hr', 4.7],
        ['AC & Appliances', 'Washing Machine Installation', '', 399, '45 min', 4.8],
        ['AC & Appliances', 'Refrigerator / Fridge Service', '', 499, '1 hr', 4.8],
        ['AC & Appliances', 'Microwave / OTG Repair', '', 399, '45 min', 4.6],
        ['AC & Appliances', 'Chimney / Exhaust Cleaning', '', 899, '1 hr', 4.7],
        ['AC & Appliances', 'Geyser / Water Heater Repair', '', 499, '1 hr', 4.8],
        ['AC & Appliances', 'TV / LED Repair', '', 599, '1-2 hrs', 4.7],
        ['AC & Appliances', 'Air Cooler Service & Repair', '', 399, '1 hr', 4.7],
        ['AC & Appliances', 'Air Purifier Repair', '', 599, '1 hr', 4.7],
        ['AC & Appliances', 'Dishwasher Repair', '', 599, '1-1.5 hrs', 4.7],

        // ELECTRICIAN (20 services)
        ['Electrician', 'Electrician (General Visit)', '⚡', 199, '45 min', 4.8],
        ['Electrician', 'Fan Installation / Repair', '', 299, '30-45 min', 4.8],
        ['Electrician', 'Light / Fixture Installation', '', 249, '30 min', 4.8],
        ['Electrician', 'IMCB / DB Box Work', '', 499, '1 hr', 4.7],
        ['Electrician', 'Inverter / Battery Installation', '', 799, '1-2 hrs', 4.7],
        ['Electrician', 'Earthing & Wiring Check', '', 499, '1 hr', 4.8],
        ['Electrician', 'Plumber (General Visit)', '', 199, '45 min', 4.8],
        ['Electrician', 'Tap / Mixer Replacement', '', 549, '45 min', 4.8],
        ['Electrician', 'Toilet Flush Repair', '', 349, '45-60 min', 4.7],
        ['Electrician', 'Drainage Pipe Unclogging', '', 449, '45 min', 4.7],
        ['Electrician', 'Basin / Sink Fitting', '', 599, '1 hr', 4.8],
        ['Electrician', 'Carpenter (General Visit)', '', 249, '1 hr', 4.7],
        ['Electrician', 'Door / Window Repair', '', 449, '1-2 hrs', 4.8],
        ['Electrician', 'Lock / Handle Replacement', '', 349, '45 min', 4.8],
        ['Electrician', 'Wall Drilling & TV Mounting', '', 399, '45 min', 4.8],
        ['Electrician', 'Wooden Shelf / Wardrobe Repair', '', 599, '1-2 hrs', 4.7],

        // VEHICLE CARE (14 services)
        ['Vehicle Care', 'Car Wash (Exterior + Interior)', '🚗', 499, '45 min', 4.7],
        ['Vehicle Care', 'Car Interior Deep Clean', '', 1499, '2-3 hrs', 4.8],
        ['Vehicle Care', 'Bike Wash & Polish', '🏍️', 299, '30-45 min', 4.7],
        ...
        // HEALTH & CARE (12 services)
        ['Health & Care', 'Nurse / Attendant (Day Shift)', '⚕️', 1999, '8 hrs', 4.9],
        ...
        // SMART SOCIETY HUB (20 services)
        ['Smart Society Hub', 'Society Gate Motor Repair', '🏢', 1899, '2-3 hrs', 4.8],
        ['Smart Society Hub', 'Lift Maintenance / Repair', '', 3499, 'Site Visit', 4.9],
        ['Smart Society Hub', 'Common Area Deep Clean', '', 4999, 'Half Day', 4.7],
        ['Smart Society Hub', 'Water Pump Repair', '', 1299, '1-2 hrs', 4.8],
        ['Smart Society Hub', 'Society Electrician Visit', '', 499, '1 hr', 4.8],
        ['Smart Society Hub', 'CCTV Installation (per camera)', '', 3999, '2-3 hrs', 4.9],
        ['Smart Society Hub', 'Intercom / Video Door Bell', '', 2499, '2 hrs', 4.8],
        ['Smart Society Hub', 'Society Painting (Common Area)', '', 18, 'Per sq.ft', 4.7],
        ['Smart Society Hub', 'Garden / Landscape Maintenance', '', 2499, '3-4 hrs', 4.8],
        ['Smart Society Hub', 'Society Management Software', '', 6999, 'Monthly', 4.9],
        ['Smart Society Hub', 'AMC Contract (Annual)', '', 49999, '12 months', 4.9],
        ['Smart Society Hub', 'Member / Flat-wise Billing', '', 6999, 'Setup', 4.9],
        ['Smart Society Hub', 'Interest & Penalty Calculation', '', 2499, 'Monthly', 4.8],
        ['Smart Society Hub', 'Society Accounts & Audit', '', 9999, 'Annual', 4.9],
        ['Smart Society Hub', 'Plumbing AMC (Society)', '', 14999, '12 months', 4.8],
        ['Smart Society Hub', 'Security Guard Deployment', '', 18999, 'Monthly', 4.8],
        ['Smart Society Hub', 'Parking Management Setup', '', 6999, 'Setup', 4.7],

        // WATER TESTING (4 services)
        ...
        // TOURS & TRAVELS (14 services)
        ['Tours & Travels', 'Hire Driver (Local - 4 hrs)', '✈️', 599, '4 hrs', 4.8],
    ...
    foreach ($allServices as $svc) {
        ...
        $stmt = $conn->prepare("INSERT INTO services (category_id, name, emoji, price, duration, rating) VALUES (?, ?, ?, ?, ?, ?)");
        $stmt->bind_param("isissd", $categoryId, $serviceName, $emoji, $price, $duration, $rating);
        if ($stmt->execute()) {
            $inserted++;
        }
        $stmt->close();
    ...
    echo json_encode([
        'success' => true,
        'message' => 'Complete catalog loaded!',
