...
try {
    ...
    $categories = [
        ['Insta Help', '⚡', '#FFE5E5', 'Emergency fixes'],
        ['Women\'s Salon & Spa', '💇‍♀️', '#FFF0E5', 'Beauty & wellness'],
        ['Men\'s Salon & Massage', '💆‍♂️', '#F0F5FF', 'Grooming & massage'],
        ['Professional Cleaning', '🧹', '#E5F5E5', 'Deep cleaning'],
        ['Home Painting', '🎨', '#FFF5E5', 'Painting & waterproofing'],
        ['AC & Appliance Repair', '❄️', '#E5F5FF', 'AC & appliances'],
        ['Electrician Plumber Carpenter', '🔧', '#FFF5E5', 'Home repairs'],
        ['Vehicle Care', '🚗', '#FFE5F5', 'Car & bike services'],
        ['Food & Catering', '🍳', '#F5E5FF', 'Catering & cooking'],
        ['Health & Care', '🏥', '#E5FFE5', 'Healthcare services'],
        ...
        ['Water Testing', '🧪', '#E0F2FE', 'Water quality'],
    ...
    $allServices = [
        ...
        ['Insta Help', 'Switchboard / Socket Repair', '', 249, '30 min', 4.8],
        ...
        ['Men\'s Salon & Massage', 'De-Tan & Clean-Up (Men)', '', 499, '45 min', 4.8],
        ...
        // PROFESSIONAL CLEANING (14)
        ['Professional Cleaning', 'Home Deep Clean (1BHK)', '🏠', 2499, '3-4 hrs', 4.9],
        ['Professional Cleaning', 'Home Deep Clean (2BHK)', '🏠', 3499, '4-5 hrs', 4.9],
        ...
        // HOME PAINTING (11)
        ['Home Painting', 'Wall Painting (Per sq.ft)', '🎨', 18, 'Per day', 4.6],
        ...
        // AC & APPLIANCE REPAIR (15)
        ['AC & Appliance Repair', 'AC Jet Service', '❄️', 599, '1.5-2 hrs', 4.8],
        ...
        ['AC & Appliance Repair', 'Water Purifier Service (RO)', '', 549, '1 hr', 4.8],
        ['AC & Appliance Repair', 'Dishwasher Repair', '', 599, '1-1.5 hrs', 4.7],

        // ELECTRICIAN PLUMBER CARPENTER (16)
        ...
        ['Electrician Plumber Carpenter', 'MCB / DB Box Work', '', 499, '1 hr', 4.7],
        ...
        ['Electrician Plumber Carpenter', 'Tap / Mixer Replacement', '', 349, '45 min', 4.8],
        ...
        ['Electrician Plumber Carpenter', 'Furniture Assembly', '', 799, '1-3 hrs', 4.7],
        ['Electrician Plumber Carpenter', 'Wall Drilling & TV Mounting', '', 399, '45 min', 4.8],
        ['Electrician Plumber Carpenter', 'Lock / Handle Replacement', '', 449, '45 min', 4.8],
        ...
        ['Vehicle Care', 'Foam / Pressure Car Wash', '', 699, '1 hr', 4.8],
        ...
        ['Health & Care', 'Dietician Consultation (Online)', '', 599, '45 min', 4.7],
        ['Health & Care', 'Doctor Home Visit (GP)', '', 899, '30-45 min', 4.8],
        ['Health & Care', 'Dental Check-up (Home)', '', 799, '30 min', 4.7],
        ...
        ['Pooja Services', 'Satyanarayan Katha', '', 2999, '2-3 hrs', 4.9],
        ...
        ['Festival Services', 'Ganpati Idol Booking & Delivery', '', 2499, 'Pre-order', 4.8],
        ...
        ['Festival Services', 'New Year Party Decoration', '', 4999, '3-4 hrs', 4.8],
        ...
        ['Pest Control', 'Termite Treatment (Anti-Termite)', '', 3499, '2-3 hrs', 4.8],
        ...
        // HOLOGRAM SERVICES (10)
        ['Hologram Services', '3D Hologram Fan Display (Rental)', '🔮', 3999, 'Per day', 4.9],
    ...
    echo json_encode([
        'success' => true,
        'message' => '✅ COMPLETE DATABASE LOADED!',
