...
try {
    ...
    $categories = [
        ['Insta Help', '⚡', '#FFE5E5', 'Quick 30-60 min fixes'],
        ['Women\'s Salon & Spa', '💇‍♀️', '#FFF0E5', 'Beauty & wellness services'],
        ['Men\'s Salon & Massage', '💆‍♂️', '#F0F5FF', 'Grooming & massage'],
        ['Cleaning', '🧹', '#E5F5E5', 'Home cleaning services'],
        ['Home Painting', '🎨', '#FFF5E5', 'Painting & waterproofing'],
        ['AC & Appliance Repair', '❄️', '#E5F5FF', 'Appliance maintenance'],
        ['Electrician, Plumber & Carpenter', '🔧', '#FFF5E5', 'Home repairs'],
        ['Vehicle Care', '🚗', '#FFE5F5', 'Car & bike services'],
        ['Food & Catering', '🍳', '#F5E5FF', 'Catering services'],
        ...
        ['Pest Control', '🐜', '#FFF5E5', 'Pest elimination'],
        ['Smart Society Management', '🏢', '#E5F5FF', 'Society services'],
        ['Real Estate', '🏠', '#FFE5F5', 'Property services'],
        ['Interior Designer', '🛋️', '#F5E5FF', 'Interior design'],
        ['Hologram Services', '🔮', '#E5FFE5', 'Holographic displays'],
        ['Fire Safety', '🧯', '#FFF0E0', 'Fire safety'],
        ['Water Proofing', '💧', '#E0F7FA', 'Waterproofing'],
        ['Water Testing', '🧪', '#E0F2FE', 'Water testing'],
    ...
    // COMPLETE SERVICE LIST WITH ALL PRICING
    $allServices = [
        // Insta Help
