...
class HomePaintingScreen extends StatefulWidget {
  const HomePaintingScreen({Key? key}) : super(key: key);

  @override
  State<HomePaintingScreen> createState() => _HomePaintingScreenState();
}

class _HomePaintingScreenState extends State<HomePaintingScreen>
  ...
  final List<Map<String, dynamic>> _services = [
    {'icon': '🎨', 'name': 'Interior Wall Painting (Per sq.ft)', 'duration': 'Per sq.ft', 'rating': 4.8, 'price': 35},
    {'icon': '🎨', 'name': 'Exterior Wall Painting (Per sq.ft)', 'duration': 'Per sq.ft', 'rating': 4.7, 'price': 45},
    {'icon': '🏠', 'name': 'Full Home Painting (1BHK)', 'duration': '3-4 days', 'rating': 4.9, 'price': 8999},
    {'icon': '🏠', 'name': 'Full Home Painting (2BHK)', 'duration': '4-5 days', 'rating': 4.9, 'price': 12999},
    {'icon': '🌊', 'name': 'Waterproofing & Sealant', 'duration': '1-2 days', 'rating': 4.8, 'price': 3999},
    {'icon': '✨', 'name': 'Texture & Wallpaper Application', 'duration': '2-3 days', 'rating': 4.7, 'price': 4999},
  ];
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          const Text("Home Painting", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.black)),
          Text('Interior, exterior, waterproofing & more', style: TextStyle(fontSize: 11, color: Colors.grey.shade600, fontWeight: FontWeight.w400)),
        ]),
      ),
