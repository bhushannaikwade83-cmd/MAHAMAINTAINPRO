...
class PoojaServicesScreen extends StatefulWidget {
  const PoojaServicesScreen({Key? key}) : super(key: key);

  @override
  State<PoojaServicesScreen> createState() => _PoojaServicesScreenState();
}

class _PoojaServicesScreenState extends State<PoojaServicesScreen>
  ...
  final List<Map<String, dynamic>> _services = [
    {'icon': '🙏', 'name': 'Daily Pooja & Aarti', 'duration': '30-45 min', 'rating': 4.9, 'price': 499},
    {'icon': '🕯️', 'name': 'Housewarming Ceremony', 'duration': '2-3 hrs', 'rating': 4.9, 'price': 3999},
    {'icon': '💍', 'name': 'Wedding Rituals & Ceremonies', 'duration': 'Full Day', 'rating': 4.8, 'price': 9999},
    {'icon': '👶', 'name': 'Naming Ceremony (Naamkaran)', 'duration': '1.5-2 hrs', 'rating': 4.9, 'price': 2499},
    {'icon': '🧿', 'name': 'Thread Ceremony (Janeu)', 'duration': '2-3 hrs', 'rating': 4.8, 'price': 1999},
    {'icon': '🔱', 'name': 'Shradh & Pitru Pooja', 'duration': '2-4 hrs', 'rating': 4.9, 'price': 2999},
  ];
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          const Text("Pooja Services", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.black)),
          Text('पूजा सेवा • Religious ceremonies & rituals', style: TextStyle(fontSize: 11, color: Colors.grey.shade600, fontWeight: FontWeight.w400)),
        ]),
      ),
