...
class SmartSocietyHubScreen extends StatefulWidget {
  const SmartSocietyHubScreen({Key? key}) : super(key: key);

  @override
  State<SmartSocietyHubScreen> createState() => _SmartSocietyHubScreenState();
}

class _SmartSocietyHubScreenState extends State<SmartSocietyHubScreen>
  ...
  final List<Map<String, dynamic>> _services = [
    {'icon': '🚪', 'name': 'Society Gate Motor Repair', 'duration': '2-3 hrs', 'rating': 4.8, 'price': 1299},
    {'icon': '🛗', 'name': 'Lift Maintenance / Repair', 'duration': 'Site Visit', 'rating': 4.9, 'price': 2499},
    {'icon': '🧹', 'name': 'Common Area Deep Clean', 'duration': '3-4 hrs', 'rating': 4.7, 'price': 1899},
    {'icon': '📹', 'name': 'CCTV Installation & Setup', 'duration': '2-3 hrs', 'rating': 4.8, 'price': 3499},
    {'icon': '💡', 'name': 'Electrical Maintenance', 'duration': '1-2 hrs', 'rating': 4.9, 'price': 899},
    {'icon': '🔧', 'name': 'Plumbing & Water Management', 'duration': '1-2 hrs', 'rating': 4.8, 'price': 699},
  ];
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          const Text("Smart Society Hub", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.black)),
          Text('Gate, lift, CCTV, AMC & management', style: TextStyle(fontSize: 11, color: Colors.grey.shade600, fontWeight: FontWeight.w400)),
        ]),
      ),
