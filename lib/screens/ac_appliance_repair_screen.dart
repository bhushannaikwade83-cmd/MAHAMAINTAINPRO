...
class ACApplianceRepairScreen extends StatefulWidget {
  const ACApplianceRepairScreen({Key? key}) : super(key: key);

  @override
  State<ACApplianceRepairScreen> createState() => _ACApplianceRepairScreenState();
}

class _ACApplianceRepairScreenState extends State<ACApplianceRepairScreen>
  ...
  final List<Map<String, dynamic>> _services = [
    {'icon': '❄️', 'name': 'AC Service & Deep Clean', 'duration': '1.5-2 hrs', 'rating': 4.9, 'price': 499},
    {'icon': '❄️', 'name': 'AC Gas Refill', 'duration': '1 hr', 'rating': 4.8, 'price': 1299},
    {'icon': '🔧', 'name': 'AC Installation & Setup', 'duration': '2-3 hrs', 'rating': 4.8, 'price': 999},
    {'icon': '🧊', 'name': 'Refrigerator Repair & Service', 'duration': '1.5-2 hrs', 'rating': 4.7, 'price': 799},
    {'icon': '🌊', 'name': 'Washing Machine Repair', 'duration': '1-1.5 hrs', 'rating': 4.9, 'price': 699},
    {'icon': '📺', 'name': 'TV & LED Repair', 'duration': '1-2 hrs', 'rating': 4.8, 'price': 799},
  ];
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          const Text("AC & Appliance Repair", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.black)),
          Text('AC, fridge, washing machine, TV & more', style: TextStyle(fontSize: 11, color: Colors.grey.shade600, fontWeight: FontWeight.w400)),
        ]),
      ),
