...
class FestivalServicesScreen extends StatefulWidget {
  const FestivalServicesScreen({Key? key}) : super(key: key);

  @override
  State<FestivalServicesScreen> createState() => _FestivalServicesScreenState();
}

class _FestivalServicesScreenState extends State<FestivalServicesScreen>
  ...
  final List<Map<String, dynamic>> _services = [
    {'icon': '🐘', 'name': 'Ganpati Decoration & Setup', 'duration': 'Half Day', 'rating': 4.9, 'price': 3999},
    {'icon': '🐘', 'name': 'Ganpati Visarjan Arrangements', 'duration': '2-3 hrs', 'rating': 4.8, 'price': 1999},
    {'icon': '🐘', 'name': 'Ganpati Idol Booking & Delivery', 'duration': '2-3 hrs', 'rating': 4.9, 'price': 899},
    {'icon': '🪔', 'name': 'Diwali Decoration & Lighting', 'duration': 'Half Day', 'rating': 4.8, 'price': 2499},
    {'icon': '🎉', 'name': 'Navratri Setup & Arrangements', 'duration': '3-4 hrs', 'rating': 4.7, 'price': 1799},
    {'icon': '🎊', 'name': 'Festival Catering & Sweets', 'duration': '2-3 hrs', 'rating': 4.9, 'price': 1299},
  ];
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          const Text("Festival Services", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.black)),
          Text('Ganpati, Diwali, Navratri & more', style: TextStyle(fontSize: 11, color: Colors.grey.shade600, fontWeight: FontWeight.w400)),
        ]),
      ),
