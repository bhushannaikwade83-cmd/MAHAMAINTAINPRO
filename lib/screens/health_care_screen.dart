...
class _HealthCareScreenState extends State<HealthCareScreen>
  ...
  final List<Map<String, dynamic>> _services = [
    {'icon': '⚕️', 'name': 'Nurse Care & Assistance', 'duration': '4 hrs', 'rating': 4.9, 'price': 1499},
    {'icon': '🧘', 'name': 'Physiotherapy & Rehabilitation', 'duration': '1 hr', 'rating': 4.8, 'price': 799},
    {'icon': '🩸', 'name': 'Blood Test & Sample Collection', 'duration': '30 min', 'rating': 4.9, 'price': 299},
    {'icon': '💊', 'name': 'Medicine Delivery', 'duration': 'Same Day', 'rating': 4.7, 'price': 199},
    {'icon': '👴', 'name': 'Elder Care & Companion', 'duration': '8 hrs', 'rating': 4.8, 'price': 1299},
    {'icon': '💉', 'name': 'Vaccination & Immunization', 'duration': '30-45 min', 'rating': 4.9, 'price': 599},
  ];
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          const Text("Health & Care", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.black)),
          Text('Nurse, physio, blood test & elder care', style: TextStyle(fontSize: 11, color: Colors.grey.shade600, fontWeight: FontWeight.w400)),
        ]),
      ),
