...
class MensSalonScreen extends StatefulWidget {
  const MensSalonScreen({Key? key}) : super(key: key);
...
class _MensSalonScreenState extends State<MensSalonScreen>
  ...
  final List<Map<String, dynamic>> _services = [
    {'icon': '💈', 'name': 'Hair Cut (Men)', 'duration': '30 min', 'rating': 4.8, 'price': 199},
    {'icon': '👨', 'name': 'Hair Cut (Kids, Under 12)', 'duration': '20 min', 'rating': 4.8, 'price': 149},
    {'icon': '🪮', 'name': 'Shave', 'duration': '15 min', 'rating': 4.9, 'price': 99},
    {'icon': '💆‍♂️', 'name': 'Head Massage', 'duration': '30 min', 'rating': 4.7, 'price': 249},
    {'icon': '✂️', 'name': 'Beard Styling', 'duration': '20 min', 'rating': 4.8, 'price': 179},
    {'icon': '💅', 'name': 'Grooming Package', 'duration': '60 min', 'rating': 4.9, 'price': 499},
  ];
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          const Text("Men's Salon & Massage", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.black)),
          Text('Haircut, grooming & body massage', style: TextStyle(fontSize: 11, color: Colors.grey.shade600, fontWeight: FontWeight.w400)),
        ]),
      ),
