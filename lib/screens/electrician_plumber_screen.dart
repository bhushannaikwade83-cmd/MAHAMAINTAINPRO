...
class ElectricianPlumberScreen extends StatefulWidget {
  const ElectricianPlumberScreen({Key? key}) : super(key: key);

  @override
  State<ElectricianPlumberScreen> createState() => _ElectricianPlumberScreenState();
}

class _ElectricianPlumberScreenState extends State<ElectricianPlumberScreen>
  ...
  final List<Map<String, dynamic>> _services = [
    {'icon': '⚡', 'name': 'Electrician (General Visit)', 'duration': '30-45 min', 'rating': 4.9, 'price': 199},
    {'icon': '💡', 'name': 'Fan Installation/Repair', 'duration': '30-45 min', 'rating': 4.8, 'price': 249},
    {'icon': '🔌', 'name': 'Light/Fixture Installation', 'duration': '45-60 min', 'rating': 4.9, 'price': 299},
    {'icon': '🚰', 'name': 'Plumber (General Visit)', 'duration': '45-60 min', 'rating': 4.8, 'price': 249},
    {'icon': '🔧', 'name': 'Pipe Repair & Replacement', 'duration': '1-2 hrs', 'rating': 4.9, 'price': 399},
    {'icon': '🛠️', 'name': 'Carpenter (General Visit)', 'duration': '1-2 hrs', 'rating': 4.7, 'price': 299},
  ];
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          const Text("Electric, Plumb & Carpenter", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.black)),
          Text('46-min response • All home repairs', style: TextStyle(fontSize: 11, color: Colors.grey.shade600, fontWeight: FontWeight.w400)),
        ]),
      ),
