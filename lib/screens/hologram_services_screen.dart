...
class HologramServicesScreen extends StatefulWidget {
  const HologramServicesScreen({Key? key}) : super(key: key);

  @override
  State<HologramServicesScreen> createState() => _HologramServicesScreenState();
}

class _HologramServicesScreenState extends State<HologramServicesScreen>
  ...
  final List<Map<String, dynamic>> _services = [
    {'icon': '🔮', 'name': '3D Hologram Fan Display (Rental)', 'duration': 'Per day', 'rating': 4.9, 'price': 2999},
    {'icon': '✨', 'name': 'Hologram Fan Purchase & Setup', 'duration': '1-2 days', 'rating': 4.9, 'price': 14999},
    {'icon': '🎆', 'name': 'Event Hologram Projection', 'duration': '2-3 hrs', 'rating': 4.8, 'price': 4999},
    {'icon': '🎨', 'name': 'Custom Hologram Content Creation', 'duration': '3-5 days', 'rating': 4.7, 'price': 7999},
    {'icon': '📱', 'name': 'AR/VR Experience Setup', 'duration': '2-3 hrs', 'rating': 4.8, 'price': 3499},
    {'icon': '🎭', 'name': 'Hologram Branding Solutions', 'duration': 'Consultation', 'rating': 4.9, 'price': 5999},
  ];
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          const Text("Hologram Services", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.black)),
          Text('3D hologram display, events & branding', style: TextStyle(fontSize: 11, color: Colors.grey.shade600, fontWeight: FontWeight.w400)),
        ]),
      ),
