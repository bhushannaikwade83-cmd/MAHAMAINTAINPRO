...
class ToursAndTravelsScreen extends StatefulWidget {
  const ToursAndTravelsScreen({Key? key}) : super(key: key);

  @override
  State<ToursAndTravelsScreen> createState() => _ToursAndTravelsScreenState();
}

class _ToursAndTravelsScreenState extends State<ToursAndTravelsScreen>
  ...
  final List<Map<String, dynamic>> _services = [
    {'icon': '🧑‍✈️', 'name': 'Hire Driver (Local - 4 hrs)', 'duration': '4 hrs', 'rating': 4.8, 'price': 499},
    {'icon': '🧑‍✈️', 'name': 'Hire Driver (Local - 8 hrs)', 'duration': '8 hrs', 'rating': 4.9, 'price': 899},
    {'icon': '🚕', 'name': 'Outstation Cab Rental', 'duration': 'Per km', 'rating': 4.7, 'price': 1299},
    {'icon': '✈️', 'name': 'Tour Package (3 Days)', 'duration': '3 days', 'rating': 4.8, 'price': 8999},
    {'icon': '🏨', 'name': 'Hotel Booking & Arrangements', 'duration': 'Flexible', 'rating': 4.9, 'price': 2499},
    {'icon': '🗺️', 'name': 'Travel Insurance & Visa Support', 'duration': 'Documentation', 'rating': 4.8, 'price': 1999},
  ];
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          const Text("Tours & Travels", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.black)),
          Text('Car rentals, tour packages & drivers', style: TextStyle(fontSize: 11, color: Colors.grey.shade600, fontWeight: FontWeight.w400)),
        ]),
      ),
