...
class ProfessionalCleaningScreen extends StatefulWidget {
  const ProfessionalCleaningScreen({Key? key}) : super(key: key);

  @override
  State<ProfessionalCleaningScreen> createState() => _ProfessionalCleaningScreenState();
}

class _ProfessionalCleaningScreenState extends State<ProfessionalCleaningScreen>
  ...
  final List<Map<String, dynamic>> _services = [
    {'icon': '🧹', 'name': 'Home Deep Clean (1BHK)', 'duration': '2-3 hrs', 'rating': 4.9, 'price': 999},
    {'icon': '🧹', 'name': 'Home Deep Clean (2BHK)', 'duration': '3-4 hrs', 'rating': 4.9, 'price': 1499},
    {'icon': '🧹', 'name': 'Home Deep Clean (3BHK)', 'duration': '4-5 hrs', 'rating': 4.8, 'price': 1999},
    {'icon': '🍳', 'name': 'Kitchen Deep Clean', 'duration': '1.5-2 hrs', 'rating': 4.9, 'price': 799},
    {'icon': '🛁', 'name': 'Bathroom & Toilet Deep Clean', 'duration': '1-1.5 hrs', 'rating': 4.8, 'price': 599},
    {'icon': '🪟', 'name': 'Window & Glass Cleaning', 'duration': '1-2 hrs', 'rating': 4.7, 'price': 499},
  ];
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          const Text("Professional Cleaning", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.black)),
          Text('Deep clean, kitchen, bathroom & more', style: TextStyle(fontSize: 11, color: Colors.grey.shade600, fontWeight: FontWeight.w400)),
        ]),
      ),
