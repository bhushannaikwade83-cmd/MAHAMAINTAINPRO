...
class VehicleCareScreen extends StatefulWidget {
  const VehicleCareScreen({Key? key}) : super(key: key);
...
class _VehicleCareScreenState extends State<VehicleCareScreen>
  ...
  final List<Map<String, dynamic>> _services = [
    {'icon': '🚗', 'name': 'Car Wash & Detailing', 'duration': '1-2 hrs', 'rating': 4.9, 'price': 499},
    {'icon': '🏍️', 'name': 'Bike Wash & Cleaning', 'duration': '45-60 min', 'rating': 4.8, 'price': 299},
    {'icon': '🔧', 'name': 'Car Service & Maintenance', 'duration': '2-3 hrs', 'rating': 4.9, 'price': 1299},
    {'icon': '❄️', 'name': 'Car AC Service & Repair', 'duration': '1.5-2 hrs', 'rating': 4.8, 'price': 999},
    {'icon': '⛽', 'name': 'Car Fuel & Battery Change', 'duration': '1 hr', 'rating': 4.7, 'price': 599},
    {'icon': '🛞', 'name': 'Tire Repair & Alignment', 'duration': '1-1.5 hrs', 'rating': 4.8, 'price': 699},
  ];
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          const Text("Vehicle Care", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.black)),
          Text('Car & bike wash, detailing, AC & repairs', style: TextStyle(fontSize: 11, color: Colors.grey.shade600, fontWeight: FontWeight.w400)),
        ]),
      ),
