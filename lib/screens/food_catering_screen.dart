...
class FoodCateringScreen extends StatefulWidget {
  const FoodCateringScreen({Key? key}) : super(key: key);

  @override
  State<FoodCateringScreen> createState() => _FoodCateringScreenState();
}

class _FoodCateringScreenState extends State<FoodCateringScreen>
  ...
  final List<Map<String, dynamic>> _services = [
    {'icon': '🍱', 'name': 'Home Cook Service (Per Meal)', 'duration': 'Daily', 'rating': 4.9, 'price': 299},
    {'icon': '🍜', 'name': 'Tiffin Meal Service (Weekly)', 'duration': '5 Days', 'rating': 4.8, 'price': 1499},
    {'icon': '🎂', 'name': 'Party Catering (50 Persons)', 'duration': 'Full Day', 'rating': 4.9, 'price': 4999},
    {'icon': '🥘', 'name': 'Wedding Catering (Per Person)', 'duration': 'Custom', 'rating': 4.9, 'price': 399},
    {'icon': '🥗', 'name': 'Diet Meal Plans (Weekly)', 'duration': '7 Days', 'rating': 4.7, 'price': 1999},
    {'icon': '🍰', 'name': 'Cake & Dessert Delivery', 'duration': 'Same Day', 'rating': 4.8, 'price': 599},
  ];
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          const Text("Food & Catering", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.black)),
          Text('Home cook, tiffin, party catering & more', style: TextStyle(fontSize: 11, color: Colors.grey.shade600, fontWeight: FontWeight.w400)),
        ]),
      ),
