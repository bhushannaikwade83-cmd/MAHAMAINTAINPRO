...
class _RealEstateScreenState extends State<RealEstateScreen>
  ...
  final List<Map<String, dynamic>> _services = [
    {'icon': '🏠', 'name': 'Property Site Visit & Inspection', 'duration': '2-3 hrs', 'rating': 4.8, 'price': 499},
    {'icon': '🔑', 'name': 'Flat / Home for Rent (Listing)', 'duration': '7-14 days', 'rating': 4.7, 'price': 999},
    {'icon': '🏡', 'name': 'Home Valuation & Assessment', 'duration': '1-2 hrs', 'rating': 4.8, 'price': 1499},
    {'icon': '📋', 'name': 'Legal Documentation & Registration', 'duration': 'Site Visit', 'rating': 4.9, 'price': 2999},
    {'icon': '🔍', 'name': 'Property Title Search & Verification', 'duration': '3-5 days', 'rating': 4.7, 'price': 1799},
    {'icon': '🤝', 'name': 'Buyer-Seller Mediation', 'duration': '2-3 hrs', 'rating': 4.8, 'price': 1599},
  ];
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          const Text("Real Estate", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.black)),
          Text('Buy, sell, rent & property services', style: TextStyle(fontSize: 11, color: Colors.grey.shade600, fontWeight: FontWeight.w400)),
        ]),
      ),
